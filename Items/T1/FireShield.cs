    ...
    public class FireShield : ItemBoilerplate<FireShield> {
        ...
        protected override void SetupAttributesInner() {
            ...
            RegLang("Fire Shield",
            	...
            	"<style=cIsDamage>When hit for more than " + pct(healthThreshold,1,1f) + " max health</style>, <style=cIsDamage>explode</style> for up to <style=cIsDamage>" + pct(baseDmg) + "</style> <style=cStack>(+" + pct(stackDmg) + " per stack)</style> damage to enemies within <style=cIsDamage>" + baseRadius.ToString("N0") + " m</style>.",
