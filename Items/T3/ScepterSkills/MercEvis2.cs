...
namespace ThinkInvisible.ClassicItems {
    public class MercEvis2 : ScepterSkill {
        ...
        public override SkillDef targetVariantDef => LegacyResourcesAPI.Load<SkillDef>("skilldefs/mercbody/MercBodyEvis");
        ...
        internal override void SetupAttributes() {
            ...
            myDef.icon = ClassicItemsPlugin.resources.LoadAsset<Sprite>("Assets/ClassicItems/Textures/ScepterSkillIcons/merc_evisicon.png");
